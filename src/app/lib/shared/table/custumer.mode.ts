...
export const requesData = [
  {
    idRequest: 1,
    custom: {
      time: "2023-05-19T15:18:24.976792+00:00",
      identification: "12122122",
    },
    statusName: "Solucionado",
...
export const exampleColumns = [
  ...
  { label: "Contact", property: "contact", type: "icons", visible: true },
  {
    label: "Address",
    property: "address",
    type: "text",
  ...
  { label: "Labels", property: "labels", type: "labels", visible: true },
